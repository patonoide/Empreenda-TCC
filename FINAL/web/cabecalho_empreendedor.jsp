        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header ">
                ...
                <div class="mdl-layout__header-row">
                    ...
                    <div class="android-navigation-container ">
                        <nav class="android-navigation mdl-navigation">
                            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="empreendedor_meuperfil.jsp">Perfil</a>
                            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="franquia_lista.jsp">Todas Franquias</a>
                            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="franquia_lista_recomendado.jsp"><span class="mdl-badge" data-badge="<%=total%>">Franquias Recomendadas</span></a>
            ...
            <div class="android-drawer mdl-layout__drawer">
                ...
                <nav class="mdl-navigation">
                    <nav class="android-navigation mdl-navigation">
                        <a class="mdl-navigation__link " href="empreendedor_meuperfil.jsp">Perfil</a>
                        <a class="mdl-navigation__link" href="franquia_lista.jsp">Todas Franquias</a>
                        <a class="mdl-navigation__link" href="franquia_lista_recomendado.jsp"><span class="mdl-badge" data-badge="<%=total%>">Franquias Recomendadas</span></a>
                        <a class="mdl-navigation__link " href="login_empreendedor.jsp?sair=ok">Sair</a>
