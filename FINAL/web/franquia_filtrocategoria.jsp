<%-- 
    Document   : franquia_filtrocategoria
    Created on : May 22, 2017, 5:32:10 PM
    Author     : paton
--%>
...
<%    FranquiaDAO dao = new FranquiaDAO();
    ...
    if (nome.isEmpty() == false) {
        listap = dao.filtroPesquisarCat(nome, obj.getCategoriaList().get(0));

    } else {
        lista = dao.filtroCat(obj.getCategoriaList().get(0));
    }
