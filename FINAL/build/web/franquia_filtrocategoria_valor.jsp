<%-- 
    Document   : franquia_filtrocategoria_valor
    Created on : May 22, 2017, 5:32:51 PM
    Author     : paton
--%>
...
<%    FranquiaDAO dao = new FranquiaDAO();
    ...
    if (nome.isEmpty() == false) {
        listap = dao.filtroPesquisarCatValor(nome, obj.getCategoriaList().get(0), obj.getDinheiro());

    } else {
        lista = dao.filtroCatValor(obj.getDinheiro(), obj.getCategoriaList().get(0));
    }
